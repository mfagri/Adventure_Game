      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          child: Column(
            ...
            children: [
              Text('You Finish !!',style: TextStyle(color: Colors.white,fontSize: 30,fontWeight: FontWeight.bold),),
              InkWell(
                onTap: () {
                  Navigator.pop(context);
                  Navigator.pop(context);
                },
                child: Text('Ok',style: TextStyle(color: Colors.white,fontSize: 35,fontWeight: FontWeight.bold),),
              )
            ],
          ),
        ));
